...
class DanbooruPromptGenerator:
    ...
    # === 人物预设 (默认) ===
    CHARACTER_DEFAULT = ["yousa", "1girl", "solo", "red eyes", "black hair", "(DMB_hair:1.1)"]
    ...
    ACTIONS_POOL = [
        ...
        "caramelldansen","finger gun","hand on hip","hands on another's breast",
        "hands on hips","holding","holding hands","middle finger","salute",
        ...
        "arm hug","armpit peek","arms around neck","arms at sides","beckoning",
        ...
        "convenient head","convenient leg","crossed arms","cuddling","dress lift",
        "dress removed","dual wielding","palm","feeding","fingering through clothes",
        "flapping","glomp","grabbing","guided breast grab","hair flip",
        "hair tucking","hair twirling","hand between legs","hand in hair",
        "hand in panties","hand on another's cheek","hand on another's chest",
        "hand on another's chin","hand on another's","hand on another's stomach",
        "hand on own knee","hand on own stomach","hand to own mouth","heart hands",
        "heart hands duo","holding arrow","holding condom","holding panties",
        "holding strap","holding syringe","holding underwear","holding whip",
        "index finger raised","lifted by another","lifted by self","necktie grab",
        "ok sign","own hands together","rubbing eyes","shading eyes","sheet grab",
        "shoujo kitou-chuu","talking on phone","through clothes","tying","yawning",
        "drying hair","v over eye","grabbing another's hair","tying hair",
        "mimikaki","holding eyewear","hand on ear","adjusting eyewear",
        "hand on another's head","hand on own head","hand on own forehead",
        "hand on another's face","hands on another's face","hands on own face",
        "hand on own cheek","hand on headwear","hand on own chest",
        "hand on another's shoulder","hand on own shoulder","hand on own ass",
        "hands on ass","hands on own knees","hands on feet","hand on another's hand",
        ...
        "finger frame","fist bump","fist in hand","hand glasses","own hands clasped",
        "heart arms","heart hands trio","high five","horns pose","noogie",
        "palm-fist greeting","palm-fist tap","penetration gesture","pinky swear",
        "shadow puppet","tsuki ni kawatte oshioki yo","steepled fingers","akanbe",
        "slit throat (gesture)","pinky out","pointing","pointing at self",
        ...
        "heart tail","heart tail duo","kuji-in","shrugging","toe-point",
        ...
        "lotus position","sitting on person","thigh straddling","upright straddle",
        ...
        "standing split","watson cross","arm around neck","hand on another's neck",
        "hand on own neck","neck biting","necking","kissing neck"
    ]
    ...
    "disc (medium)", "expression chart", "faux figurine", "faux traditional media", 
