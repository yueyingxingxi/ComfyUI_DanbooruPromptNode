...
class DanbooruPromptGenerator:
        ...
        return {
            "required": {
                ...
                "custom_character": ("STRING", {
                    "multiline": True, 
                    "default": "yousa,red eyes,black hair,(DMB_hair:1.1),looking at viewer,",
                    "placeholder": "关闭character_default时输入自定义人物标签\n默认yousa,red eyes,black hair,(DMB_hair:1.1), looking at viewer"
                }),
    ...
    R18_POOL = [
        ...
        "penetration","fisting","double penetration",
        ...
        "slave","shibari","bondage","bdsm",
        "pillory","rope","futanari","incest","twincest","pegging",
        "ganguro","bestiality","molestation","voyeurism","exhibitionism",
        "rape","about to be raped",
    ]
    
    # === 服饰池  ===
    CLOTHES_POOL = [
        "collarbone","muscle","cape","camisole","detached sleeves","hoodie",
        "long sleeves","robe","off shoulder","bare shoulders","topless",
        "open clothes","open robe","naked cape","naked shirt","harness","whip marks",
        ...
        "capelet","cloak","coat","collared jacket","duffel coat",
        "hooded cape","hooded cloak","hooded coat","hooded jacket","labcoat",
        "military jacket","pant suit","blouse","cardigan","casual",
        ...
        "thighs","thick thighs","kneepits","foot","toes","apron","belt",
        "bike shorts","bloomers","legwear","lowleg panties","miniskirt",
        "no panties","panties","pleated skirt","side-tie panties",
        "skirt","striped panties","thong","trefoil",
        "zettai ryouiki","shorts","bottomless","pantyshot",
        "barefoot","bare legs","ankle lace-up","butt plug","leg garter",
        "bandaged leg","anklet","bikini bottom","buruma","capri pants","chaps","checkered skirt",
        ...
        "backless outfit","baseball uniform","biker clothes","bikesuit",
        "bikini skirt","bodysuit under clothes","front-print panties","g-string",
        "highleg panties","lace-trimmed panties","panties aside",
        ...
        "hanfu","corset","skirt around one leg","panties around one leg",
        "swimsuit aside","wet panties","crotchless panties",
        "layered skirt","waist apron","pettiskirt","tutu","layered dress",
        "off-shoulder dress","bandaid on leg","leg belt",
    ...
    ACTIONS_POOL = [
        ...
        "arm up","arms behind head",
        "kimono lift","kimono pull","skirt lift","shared food","adjusting hair",
        "adjusting legwear","arm grab","arm held back",
        ...
        "cowering","crucifixion","faceplant","battoujutsu stance",
        "stretching","superhero landing","yoga",
        "slouching","twisted torso","crossed ankles","folded",
    ...
    "motion lines", "optical illusion", "anaglyph", 
